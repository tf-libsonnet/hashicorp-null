...
local d = (import 'github.com/jsonnet-libs/docsonnet/doc-util/main.libsonnet');
{
  ...
  '#withInputs':: d.fn(help='`null.data_source.withInputs` constructs a mixin object that can be merged into the `data_source`\nTerraform data source block to set or update the inputs field.\n\n\n\n**Args**:\n  - `dataSrcLabel` (`string`): The name label of the block to update.\n  - `value` (`TODO`): The value to set for the `inputs` field.\n', args=[]),
